...
S <- crossprod(scale(X, center = FALSE, scale = FALSE)) / n
```
...
L_fused_cv = smoothcholCV(k = 5, X, lambda2_seq = lambda2_seq, band = band, pen.type = "fused", max_iter = 100, stand = TRUE )
L_trend_cv = smoothcholCV(k = 5, X, lambda2_seq = lambda2_seq, band = band, pen.type = "l1trend", max_iter = 100, stand = TRUE )
L_hp_cv = smoothcholCV(k = 5, X, lambda2_seq = lambda2_seq, band = band, pen.type = "HP", max_iter = 100, stan = TRUE )
